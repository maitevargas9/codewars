...
young and beautiful?". Mary believes that a person is loved if and only if he/she is both young and beautiful, but this is 
...
namespace myjinxin
{
    ...
    public class Kata
    {
        ...
        {
            return (young == true && beautiful == true && loved == true) ||
                   (young == false && beautiful == false && loved == false)
                    ? false
                    : young == false && beautiful == true && loved == false
                    ? false
                    : young == true && beautiful == false && loved == false
                    ? false
                    : true;
        }
    }
