...
SELECT film_id, title, special_features FROM film WHERE special_features = '{"Trailers", "Deleted Scenes"}'OR special_features = '{"Deleted Scenes", "Trailers"}' ORDER BY title, film_id ASC;