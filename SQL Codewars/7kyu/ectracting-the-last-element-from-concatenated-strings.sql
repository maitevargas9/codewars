...
-- which consists of titles as concatenated strings. Each string is comprised of elements separated exclusively by 
-- the '+' character. Your objective is to extract the last element from each concatenated string in the title column. 
-- If the title does not contain the '+' symbol, display NULL for the last part.
-- split_titles:
-- id (int): primary key
