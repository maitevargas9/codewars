...
-- They know that you are a computer nerd, and they want you to query the countries table and get the 
-- answers to the trivia questions.
-- Schema of the countries table:
-- country (String)
-- capital (String)
-- continent (String)
-- The first question: from the African countries that start with the character E, get the names of 
-- their capitals ordered alphabetically.
