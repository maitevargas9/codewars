...
-- of sun heat. Initially, plant is 0 meters tall. We plant the seed at the beginning of a day. We want to know when the height
-- of the plant will reach a certain level.
-- Example
...
-- | num_days | int  |
-- -------------------
-- num_days is the number of days that it will take for the plant to reach/pass desiredHeight (including the last day in the 
-- total count).
