...
-- First, sort the list by the number of countries visited, from highest to lowest. Then, if any people have the same number of 
-- countries visited, sort them by the person's name ascending.
