...
-- You can read more about IPv4 on Wikipedia (check the First and last subnet addresses section if you need an 
-- example/explanation related to this task only)
-- Input table
-- ---------------------------------------------
-- |    Table    |     Column      |   Type    |
-- |-------------+-----------------+-----------|
