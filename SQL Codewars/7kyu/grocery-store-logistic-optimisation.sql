...
-- You have to find out how many different type of products you buy from each producer. If you take only few items from some 
-- of them you will stop going there to save the gasoline:)
...
-- products table schema id name price stock producer
-- results table schema count_products_types producer
