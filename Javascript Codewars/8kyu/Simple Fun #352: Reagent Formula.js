...
function isValid(formula) {
  ...
  let secondRule = !(formula.includes(3) && formula.includes(4));
  let thirdRule = formula.includes(5) === formula.includes(6);
  let fourthRule = formula.includes(7) || formula.includes(8);
