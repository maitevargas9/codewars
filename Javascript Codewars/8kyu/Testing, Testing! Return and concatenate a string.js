...
Betsy's recently taken a test and she is just about to get her results. Her school have an online system where each student will 
recieve a message telling them whether they've passed or failed.

Complete the function to give the 3 strings str1, str2, str3 the correct values to ensure that each student recieves the right 
message. 70 is the pass mark, so create a function that uses this grade boundary and returns either:
