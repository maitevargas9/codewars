...
Your task is to return an object which includes the count of food options selected by the developers on the meetup sign-up 
form..
...
function orderFood(list) {
  return list.reduce(
    (pre, val) => ((pre[val.meal] = -~pre[val.meal]), pre),
    {}
  );
}
