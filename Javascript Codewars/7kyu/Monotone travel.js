...
But you're pretty sure that at least at one point Peter's altitude doesn't rise, but fall. To get him, you use a 
...
var isMonotone = function (arr) {
  return arr.every((x, y) => y == 0 || arr[y] >= arr[y - 1]) ? true : false;
};
