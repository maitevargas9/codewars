...
There're k square apple boxes full of apples. If a box is of size m, then it contains m × m apples. You noticed two interesting
...
function appleBoxes(k) {
  ...
  return even.reduce((x, y) => x + y, 0) - odd.reduce((x, y) => x + y, 0);
}
