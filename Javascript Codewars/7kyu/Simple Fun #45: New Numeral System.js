...
numeral systems, he introduced his own numeral system, which he's convinced will help clarify things. His numeral system has 
base 26, and its digits are represented by English capital letters - A for 0, B for 1, and so on.
...
function newNumeralSystem(number) {
  ...
  return array
    .map((x, y) => `${x} + ${array[array.length - 1 - y]}`)
    .slice(0, Math.round(array.length / 2));
}
