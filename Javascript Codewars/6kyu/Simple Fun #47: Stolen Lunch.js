...
Your nephew gave you one of the notes in hope that you can decipher it for him. And you did: it looks like all the digits in it 
are replaced with letters and vice versa. Digit 0 is replaced with 'a', 1 is replaced with 'b' and so on, with digit 9 replaced 
by 'j'.
...
function stolenLunch(note) {
  return note.replace(/[\da-j]/g, (val) =>
    String.fromCharCode(val.charCodeAt() - (isNaN(val) ? 49 : -49))
  );
}
