...
2: product(2) = 2; 8: product(8) = 8; 121: product(121) = 1 * 2 * 1 = 2; 42: product(42) = 4 * 2 = 8; 
222: product(222) = 2 * 2 * 2 = 8; 23: product(23) = 2 * 3 = 6. As you can see, there are only 3 different 
products: 2, 6 and 8.
...
function uniqueDigitProducts(a) {
  return new Set(a.map((x) => [...(x + "")].reduce((a, b) => a * b, 1))).size;
}
