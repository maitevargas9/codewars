...
for example it should also work correctly for a meetup organised in 10-years-time. The example above assumes that 
...
Order of the objects in the array should be maintained but order of the properties in the individual objects does 
not matter.
...
function addUsername(list) {
  ...
  return list.map((dev) => {
    const firstNameLower = dev.firstName.toLowerCase();
    const lastNameFirstLetter = dev.lastName[0].toLowerCase();
