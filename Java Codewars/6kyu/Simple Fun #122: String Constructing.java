...
Your task is to find the least number of operations needed to construct the given string s. Assume that all 
the letters from s appear in a at least once.
...
public class Kata {
  ...
  public static int stringConstructing(String a, String s) {
    ...
    while (index < s.length()) {
      ...
      if (buffer.charAt(0) == s.charAt(index)) {
    ...
    return operations + buffer.length();
  }
}
