...
Your task
You are given two empty arrays (truthy and falsy) and you have to fill 
this array with at least 5 elements in each which will evaluate to true or false accordingly.
*/

export const truthy = [1, 2, 3, 4, 5];
export const falsy = [false, 0, NaN, null, ""];
