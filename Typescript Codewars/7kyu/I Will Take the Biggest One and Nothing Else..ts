...
If we continue working trying to find the successive values of Ni for our starting integer N = 26 we will find the following 
chain.
...
If your starting integer is less than 5, we do not have a result higher than your starting integer. In those cases your code 
should output -1. As an example:
input:4; output:-1
You will see more examples in the fixed examples of the sample box. You have to pass 200 random tests and the values for the 
starting N are in the following range:
