...
Wikipedia: The regular paperfolding sequence, also known as the dragon curve sequence, is an infinite automatic sequence of 0s and 1s 
...
export function* paperFold(): Generator<number, any, undefined> {
  ...
  while (true) {
    const lowestBit = n & -n;
    const value = ((lowestBit << 1) & n) === 0 ? 1 : 0;
    yield value;
    n++;
  }
}
