...
to index 8 - 4 = 4 so to index 3 and 4.
...
Given n (integer > 2) write the function comp(n) (cmp in COBOL) returning the number of times where a term of u 
...
function generateU(n: number): number[] {
  const u: number[] = [];
  u[1] = 1;
  u[2] = 1;
